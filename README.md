...
Some basic `Sampler`s are provided in this package:
...
- `.histogram(width: int = 79, height: int = 23, low: Hashable = None, high: Hashable = None) -> str`: Construct a string containing a simple, scaled histogram of the data.
